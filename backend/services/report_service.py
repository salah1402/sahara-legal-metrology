...
def generate_inspection_pdf(
    ...
    ocr_engine_label = metadata.get("engine") or "NVIDIA Nemotron OCR engine"
    story.append(KeepTogether([
        ...
        Paragraph(
            ...
            f"Optical character extraction processed with {ocr_engine_label} and NVIDIA Nemotron 3 Ultra 550B semantic normalization. "
